...
public class Transcript implements Serializable {
    ...
    public static class CourseRecord implements Serializable {
        ...
        public CourseRecord(Enrollment enrollment, Course course) {
            ...
            this.subjectCode = course.getSubjectCode();
    ...
    public int getTotalCreditsRegistered() {
        return totalCreditsRegistered;
    }

    public void setTotalCreditsRegistered(int totalCreditsRegistered) {
    ...
    public int getTotalCoursesFailed() {
        return totalCoursesFailed;
    }

    public void setTotalCoursesFailed(int totalCoursesFailed) {
        this.totalCoursesFailed = totalCoursesFailed;
    }

    public int getTotalCoursesInProgress() {
        return totalCoursesInProgress;
    }

    public void setTotalCoursesInProgress(int totalCoursesInProgress) {
        this.totalCoursesInProgress = totalCoursesInProgress;
    }
    ...
    public void addSemesterRecord(SemesterRecord record) {
        this.semesterRecords.add(record);
    }
}
