...
public class CourseRegistrationDialog extends JDialog {
    private static final Logger LOGGER = Logger.getLogger(CourseRegistrationDialog.class.getName());
    ...
    private void validateRegistration() {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Lỗi khi kiểm tra đăng ký môn học", e);
        }
    }
    ...
    private void onRegister() {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Lỗi khi gửi đăng ký môn học", e);
            JOptionPane.showMessageDialog(this,
                    "Lỗi: " + e.getMessage(),
                    "Lỗi",
                    JOptionPane.ERROR_MESSAGE);
