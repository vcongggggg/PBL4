...
public class TranscriptPanel extends JPanel {
    ...
    private JPanel createSummaryPanel() {
        ...
        gpaLabel = (JLabel) ((JPanel) gpaCard.getComponent(1)).getComponent(0);
        ...
        rankLabel = (JLabel) ((JPanel) rankCard.getComponent(1)).getComponent(0);
        
        // Credits Card
        JPanel creditsCard = createInfoCard("📚 Tín Chỉ Tích Lũy", "0", Color.decode("#f39c12"));
        creditsLabel = (JLabel) ((JPanel) creditsCard.getComponent(1)).getComponent(0);
