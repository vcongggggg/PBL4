...
public class TranscriptService {
     ...
     */
    public Transcript generateTranscript(int studentId) {
        ...
        try {
            ...
            LOGGER.info("Generated transcript for student " + studentId 
            ...
            LOGGER.log(Level.SEVERE, "Error generating transcript for student " + studentId, e);
            return null;
        }
    }
     ...
     */
    public SemesterRecord getSemesterTranscript(int studentId, String academicYear, int semester) {
        try {
            Transcript fullTranscript = generateTranscript(studentId);
            if (fullTranscript == null) return null;
     ...
     */
    public Map<String, Object> calculateProjectedGPA(int studentId, int newCredits, double newGradePoints) {
     ...
     */
    public List<Transcript> getHonorStudents(int facultyId) {
        ...
        try {
            ...
            for (Student student : students) {
                Transcript transcript = generateTranscript(student.getStudentId());
                if (transcript != null 
            ...
            honorStudents.sort((t1, t2) -> 
                t2.getCumulativeGPA().compareTo(t1.getCumulativeGPA()));
     ...
     */
    public Map<String, Object> getFacultyStatistics(int facultyId) {
        ...
        try {
            ...
            for (Student student : students) {
                ...
                if (transcript != null) {
                    ...
                    if (gpa >= 3.6) excellentCount++;
                    else if (gpa >= 3.2) goodCount++;
                    else if (gpa >= 2.5) fairCount++;
                    else if (gpa >= 2.0) averageCount++;
                    else if (gpa > 0) poorCount++;
                }
            }
