...
public class TimetableService {
    ...
    public List<TimetableEntry> getStudentTimetable(int studentId) {
        ...
        try {
            ...
            for (Enrollment enrollment : enrollments) {
                // Only show enrolled and ongoing courses
                if (enrollment.getEnrollmentStatus() == Enrollment.EnrollmentStatus.ENROLLED) {
                    ...
                    if (course != null) {
                        // Accept both ONGOING and PLANNING courses for timetable
                        if (course.getCourseStatus() == Course.CourseStatus.ONGOING 
                            ...
                            // Debug: Log if dayOfWeek is null
                            if (entry.getDayOfWeek() == null) {
                                LOGGER.warning("TimetableEntry has null dayOfWeek for course: " + 
                                    course.getCourseCode() + ", scheduleDay: " + course.getScheduleDay());
                            }
                            ...
                            LOGGER.info("Course " + course.getCourseCode() + " status is " + 
                                course.getCourseStatus() + ", skipping");
                        }
                    }
                }
            }
            
            LOGGER.info("Loaded timetable for student " + studentId + ": " + timetable.size() + " entries");
    ...
    public List<TimetableEntry> getTeacherTimetable(int teacherId) {
        ...
        try {
            ...
            LOGGER.info("Loaded timetable for teacher " + teacherId + ": " + timetable.size() + " entries");
